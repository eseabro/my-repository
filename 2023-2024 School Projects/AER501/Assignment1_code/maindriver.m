function [K, D, sig, str] = maindriver(coords, connec, young, areas, P, bounds)
%%      Input Variables:
...
K = assembly(coords, connec, young, areas, nDOF, n_elem, n_node); % Create Global Stiffness matrix
d = solve_k(K, P, bounds); %incorporate BCs and solve for displacements
j = 1;
...
[sig, str] = postprocess(coords, connec, young, areas, n_elem, D); %calculate stresses and strains
